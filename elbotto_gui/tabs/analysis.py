...
class AnalysisTab(ttk.LabelFrame):
    def __init__(self, master, var_script, defaults_script="run_quickstart_tuned.py"):
        super().__init__(master, text="Analysis")
    ...
    def _pick(self):
        p = filedialog.askopenfilename(title="Select Analysis script", filetypes=[("Python","*.py"),("All","*.*")])
